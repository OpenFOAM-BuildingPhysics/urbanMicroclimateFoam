...
namespace Foam
{
    defineTypeNameAndDebug(distributedTriSurfaceMeshBugFix, 0);
    addToRunTimeSelectionTable
    (
        searchableSurface,
        distributedTriSurfaceMeshBugFix,
        dict
    );
    ...
    <
        Foam::distributedTriSurfaceMeshBugFix::distributionType,
        3
    >::names[] =
    {
        "follow",
...
const Foam::NamedEnum<Foam::distributedTriSurfaceMeshBugFix::distributionType, 3>
    Foam::distributedTriSurfaceMeshBugFix::distributionTypeNames_;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

// Read my additional data from the dictionary
bool Foam::distributedTriSurfaceMeshBugFix::read()
{
...
bool Foam::distributedTriSurfaceMeshBugFix::isLocal
(
...
void Foam::distributedTriSurfaceMeshBugFix::distributeSegment
(
    const label segmentI,
    const point& start,
    const point& end,
...
Foam::distributedTriSurfaceMeshBugFix::distributeSegments
(
...
void Foam::distributedTriSurfaceMeshBugFix::findLine
(
...
Foam::autoPtr<Foam::distributionMap>
Foam::distributedTriSurfaceMeshBugFix::calcLocalQueries
(
...
Foam::label Foam::distributedTriSurfaceMeshBugFix::calcOverlappingProcs
(
    const point& centre,
...
bool Foam::distributedTriSurfaceMeshBugFix::overlaps
(
...
void Foam::distributedTriSurfaceMeshBugFix::subsetMeshMap
(
    const triSurface& s,
...
Foam::triSurface Foam::distributedTriSurfaceMeshBugFix::subsetMesh
(
    const triSurface& s,
...
Foam::label Foam::distributedTriSurfaceMeshBugFix::findTriangle
(
...
// Merge into allSurf.
void Foam::distributedTriSurfaceMeshBugFix::merge
(
...
Foam::distributedTriSurfaceMeshBugFix::distributedTriSurfaceMeshBugFix
(
    const IOobject& io,
    const triSurface& s,
...
Foam::distributedTriSurfaceMeshBugFix::distributedTriSurfaceMeshBugFix(const IOobject& io)
:
    triSurfaceMesh
    (
        IOobject
...
void Foam::distributedTriSurfaceMeshBugFix::clearOut()
{
    globalTris_.clear();
...
const Foam::globalIndex& Foam::distributedTriSurfaceMeshBugFix::globalTris() const
{
...
void Foam::distributedTriSurfaceMeshBugFix::findNearest
(
...
void Foam::distributedTriSurfaceMeshBugFix::findLineAny
(
    const pointField& start,
    const pointField& end,
    List<pointIndexHit>& info
...
void Foam::distributedTriSurfaceMeshBugFix::findLineAll
(
    const pointField& start,
    const pointField& end,
...
void Foam::distributedTriSurfaceMeshBugFix::getRegion
(
    const List<pointIndexHit>& info,
    labelList& region
) const
...
void Foam::distributedTriSurfaceMeshBugFix::getNormal
(
    const List<pointIndexHit>& info,
    vectorField& normal
) const
...
void Foam::distributedTriSurfaceMeshBugFix::getField
(
    const List<pointIndexHit>& info,
    labelList& values
) const
...
void Foam::distributedTriSurfaceMeshBugFix::getVolumeType
(
...
Foam::triSurface Foam::distributedTriSurfaceMeshBugFix::overlappingSurface
(
    const triSurface& s,
    const List<treeBoundBox>& bbs,
...
void Foam::distributedTriSurfaceMeshBugFix::distribute
(
    const List<treeBoundBox>& bbs,
...
bool Foam::distributedTriSurfaceMeshBugFix::writeObject
(
...
void Foam::distributedTriSurfaceMeshBugFix::writeStats(Ostream& os) const
{
    boundBox bb;
    label nPoints;
