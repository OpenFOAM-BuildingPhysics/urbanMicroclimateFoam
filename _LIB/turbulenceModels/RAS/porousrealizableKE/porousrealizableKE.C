...
:
    ...
    C4_
    (
        dimensioned<scalar>::lookupOrAddToDict("C4", this->coeffDict_, 0.9)
    ),
    C5_
    (
        dimensioned<scalar>::lookupOrAddToDict("C5", this->coeffDict_, 0.9)
    ),
    sigmak_
    (
    ...
    betaP_
    (
        dimensioned<scalar>::lookupOrAddToDict("betaP", this->coeffDict_, 1.0)
    ),
    betaD_
    (
        dimensioned<scalar>::lookupOrAddToDict("betaD", this->coeffDict_, 5.1)
    ),
    Cd_(0.2),
    k_
    (
